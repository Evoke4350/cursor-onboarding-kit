...
- Location: release tag `branch-main-v1.0.0` in the current repository
...
- Branch release run: `actions/runs/22091512543` in the current repository
- Asset paths in the current repository:
  - `/releases/download/branch-main-v1.0.0/ai-engineering-workflow-jumpstart-kit-v1.0.0-main.zip`
  - `/releases/download/branch-main-v1.0.0/ai-engineering-workflow-jumpstart-docs-v1.0.0-main.zip`
  - `/releases/download/branch-main-v1.0.0/SHA256SUMS.txt`
