...
> **DSPy Integration:** This semantic address system maps directly to DSPy's formal terminology:
> - Semantic Address = DSPy **Signature** (defines inputs/outputs)
> - Quadrant/Line = DSPy **Module Logic** (which strategy to use)
> - Type = DSPy **Adapter** (formatting style)
>
